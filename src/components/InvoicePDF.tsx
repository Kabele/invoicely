                ...
                <div className="mt-16 pt-8 border-t border-gray-300">
                    <div className="grid grid-cols-2 gap-16">
                        <div>
                            ...
                            <div className="w-full h-12 border-b border-gray-400 mt-8"></div>
                            <p className="text-gray-500 text-sm mt-2">{businessInfo.businessName || 'Your Company'}</p>
                        </div>
                        <div>
                             <h4 className="font-semibold mb-2" style={{ color: brandColors.accent }}>Client Signature</h4>
                            <div className="w-full h-12 border-b border-gray-400 mt-8"></div>
                            <p className="text-gray-500 text-sm mt-2">{invoice.clientName}</p>
                        </div>
                    </div>
                </div>
